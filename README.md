...
Thanks to everyone who has improved Autopilot:

<!-- Add yourself here in your PR — this list is maintained by hand, not by a bot. -->

| Contributor | Contribution |
|---|---|
| [@Shweta-Mishra-ai](https://github.com/Shweta-Mishra-ai) | Author and maintainer |
| [@strawberry-ml](https://github.com/strawberry-ml) | Reported the prompt-injection weaknesses in [#76](https://github.com/Shweta-Mishra-ai/github-autopilot/issues/76), which drove the V7 sanitizer hardening |
| [@AnasBabari](https://github.com/AnasBabari) | Proposed injection-defence hardening in [#77](https://github.com/Shweta-Mishra-ai/github-autopilot/pull/77) |

Security reports are contributions too, and are credited here whether or not the
accompanying patch is the one that ships.
