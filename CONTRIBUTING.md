...
Contributors are listed in the [README](README.md#contributors). Add yourself in
your PR — the list is maintained by hand, not generated by a bot. Security
reports are credited there as well, whether or not the accompanying patch is the
one that ships.
