...
KNOWN_VULNS: list[tuple] = [
    ...
    # Requests
    ("requests",     r"2\.3",  "MODERATE", "GHSA-gc5v-m9x4-r6x2", "Insecure Temp File Reuse"),
    ("requests",     r"2\.3",  "MODERATE", "GHSA-9wx4-h78v-vm56", "Credential leak via URL"),

    # Cryptography 42.x
    ("cryptography", r"42\.",  "LOW",      "GHSA-79v4-65xg-pq4g", "Vulnerable OpenSSL wheels"),
    ("cryptography", r"42\.",  "LOW",      "GHSA-m959-cc7f-wv43", "Incomplete DNS constraint"),

    # Cryptography 43.x (WORSE — HIGH severity added)
    ("cryptography", r"43\.",  "LOW",      "GHSA-79v4-65xg-pq4g", "Vulnerable OpenSSL wheels"),
    ("cryptography", r"43\.",  "LOW",      "GHSA-m959-cc7f-wv43", "Incomplete DNS constraint"),
    ("cryptography", r"43\.",  "HIGH",     "GHSA-r6ph-v2qm-q3c2", "Subgroup Attack SECT Curves"),

    # Cryptography 46.x (Render build fails — needs Rust)
    ("cryptography", r"46\.",  "LOW",      "GHSA-m959-cc7f-wv43", "Incomplete DNS constraint"),
