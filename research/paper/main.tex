...
\textbf{Benchmark design as a confound.} Evidence continues to accumulate that benchmark construction, not only technique quality, drives measured outcomes~\citep{liem2023,herbold2022}. Sections~\ref{sec:rq4}--\ref{sec:rq5} contribute three instances in which construction alone reorders tools.
...
\midrule
Secret-leakage \& FP studies~\citep{meli2019,saha2020,rahman2019,basak2023} & \checkmark & & & & \\
